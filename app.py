...
if enable_prediction:
    ...
    exclude_covid = st.sidebar.checkbox(
        "COVID 연도(2020-2021) 학습 제외",
        value=True,
        help="2020-2021년은 코로나19로 비정상적 수치를 보였으므로 예측 학습에서 제외하는 것을 권장합니다."
    )
...
st.sidebar.caption(
    ...
    "*참고: 일부 수치는 추정치이며 정확한 값은 KBO 공식 자료를 참조해 업데이트하세요.*"
)
...
for team in selected_teams:
    ...
    if enable_prediction:
        ...
        if exclude_covid:
            train_data = train_data[~train_data['year'].isin([2020, 2021])]
